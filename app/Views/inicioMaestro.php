...
<body>
    ...
    <div class="recuadros-container">
        <div class="recuadro" onclick="window.location.href='menu/menuAdCalificaciones'"><!--Se establece la ruta para redireccionar al menu de las calificaciones--->
            <img src="<?= base_url('img/calificaciones.png'); ?>" alt="" height="100" class="mx-auto d-block"><!--Se establece la ruta de la imagen--->
            <h2>Administrar Calificaciones</h2>
        </div>

        <div class="recuadro" onclick="window.location.href='maestro/informacion'"><!--Se establece la ruta para redireccionar a la informacion del maestro--->
            <img src="<?= base_url('img/usuario.png'); ?>" alt="" height="100" class="mx-auto d-block"><!--Se establece la ruta de la imagen--->
            <h2>Consultar informacion</h2>
        </div>
    </div>
</body>
</html>
