...
<body>
    ...
    <div class="form-container">
        <form action="<?= base_url('maestro/insert'); ?>" method="POST">
        <?= csrf_field() ?>
            ...
            <div class="form-group">
                ...
                <input type="text" id="español" name="español">
            </div>
            <div class="form-group">
                <label for="matematicas">Matemáticas:</label>
                <input type="text" id="matematicas" name="matematicas">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" id="civismo" name="civismo">
            </div>
            <div class="form-group">
                <label for="edFisica">Educación física:</label>
                <input type="text" id="edFisica" name="edFisica">
            </div>
            <div class="form-group">
                <label for="geografia">Geografía:</label>
                <input type="text" id="geografia" name="geografia">
            </div>
            <div class="form-group">
                <label for="ciencias">Ciencias naturales:</label>
                <input type="text" id="ciencias" name="ciencias">
            </div>
