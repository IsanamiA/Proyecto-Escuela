...
<body>
    <div class="navbar">
        ...
        <p>Escuela Primaria General Lázaro Cárdenas</p>
                  <a href="<?= base_url('inicioAlumno'); ?>"><!--Se establece la ruta para retornar al inicio del alumno por medio de la imagen--->
            <img src="<?= base_url('img/inicio.png'); ?>" alt="Inicio" class="button">
        </a>

        <a href="<?= base_url('/'); ?>"><!--Se establece la ruta para retornar al inicio de sesion por medio de la imagen--->
            <img src="<?= base_url('img/cerrar.png'); ?>" alt="" class="cerrar">
        </a>
    </div>
</body>
</html>
