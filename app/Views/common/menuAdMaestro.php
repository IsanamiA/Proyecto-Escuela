...
<body>
    <div class="navbar">
        <a href="<?= base_url('menu/menuAdMaestro'); ?>"><!--Se establece la ruta para retornar al menu del maestro por medio de la imagen--->
        ...
        <a href="<?= base_url('inicio'); ?>"><!--Se establece la ruta para retornar al inicio del maestro por medio de la imagen--->
        ...
        <a href="<?= base_url('/'); ?>"><!--Se establece la ruta para retornar al inicio de sesion por medio de la imagen--->
            <img src="<?= base_url('img/cerrar.png'); ?>" alt="" class="cerrar"><!--Se establece la ruta para tomar la imagen del cerrar sesion--->
        </a>
    </div>
</body>
</html>
