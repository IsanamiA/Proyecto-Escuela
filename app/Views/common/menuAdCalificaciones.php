...
<body>
    <div class="navbar">
        <a href="<?= base_url('menu/menuAdCalificaciones'); ?>"><!--Se establece la ruta para retornar al menu de las calificaciones por medio de la imagen--->
        ...
        <a href="<?= base_url('inicioMaestro'); ?>"><!--Se establece la ruta para retornar al inicio de las calificaciones por medio de la imagen--->
