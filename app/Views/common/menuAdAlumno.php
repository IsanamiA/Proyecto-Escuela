...
<body>
    <div class="navbar">
        <a href="<?= base_url('menu/menuAdAlumno'); ?>"><!--Se establece la ruta para retornar al menu del alumno por medio de la imagen--->
            <img src="<?= base_url('img/regresar.png'); ?>" class="regresar"><!--Se establece la ruta para tomar la imagen de regresar--->
        </a>
        ...
        <a href="<?= base_url('inicio'); ?>"><!--Se establece la ruta para retornar al inicio del alumno por medio de la imagen--->
